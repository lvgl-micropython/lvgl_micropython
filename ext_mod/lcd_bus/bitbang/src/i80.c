 ...
 */
static mp_obj_t mp_lcd_i80_bus_make_new(const mp_obj_type_t *type, size_t n_args,
                                        size_t n_kw, const mp_obj_t *all_args)
{
    enum { ARG_dc, ARG_wr, ARG_data0, ARG_data1, ARG_data2, ARG_data3, ARG_data4,
           ARG_data5, ARG_data6, ARG_data7, ARG_data8, ARG_data9, ARG_data10,
           ARG_data11, ARG_data12, ARG_data13, ARG_data14, ARG_data15, ARG_cs,
           ARG_freq, ARG_dc_idle_high, ARG_dc_cmd_high, ARG_dc_dummy_high,
           ARG_dc_data_high, ARG_cmd_bits, ARG_param_bits, ARG_cs_active_high,
           ARG_reverse_color_bits, ARG_swap_color_bytes, ARG_pclk_active_low,
           ARG_pclk_idle_low };
    /*
    ...
    self->callback = mp_const_none;
        ...
        mp_raise_msg(&mp_type_NotImplementedError,
                     MP_ERROR_TEXT("LCD I80 but is not available for this MCU"));
    #else
...
mp_lcd_err_t i80_tx_color(mp_obj_t obj, int lcd_cmd, void *color, size_t color_size,
...
mp_lcd_err_t i80_init(mp_obj_t obj, uint16_t width, uint16_t height, uint8_t bpp,
                      uint32_t buffer_size, bool rgb565_byte_swap,
