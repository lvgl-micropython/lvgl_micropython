...
class SSD1963_480(display_driver_framework.DisplayDriver):
...
class SSD1963_800(display_driver_framework.DisplayDriver):
...
class SSD1963_800ALT(display_driver_framework.DisplayDriver):
...
class SSD1963_800BD(display_driver_framework.DisplayDriver):
