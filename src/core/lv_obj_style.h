...
mp_obj_t mp_lv_obj_add_style(mp_obj_t obj_in, mp_obj_t style_in, mp_obj_t selector_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_style_t *style = (lv_style_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(style_in))->obj);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
mp_obj_t mp_lv_obj_replace_style(mp_obj_t obj_in, mp_obj_t old_style_in, mp_obj_t new_style_in, mp_obj_t selector_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_style_t *old_style = (lv_style_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(old_style_in))->obj);
    lv_style_t *new_style = (lv_style_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(new_style_in))->obj);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
    bool res = lv_obj_replace_style(obj, old_style, new_style, selector);
...
mp_obj_t mp_lv_obj_remove_style(mp_obj_t obj_in, mp_obj_t style_in, mp_obj_t selector_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_style_t *style = (lv_style_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(style_in))->obj);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
mp_obj_t mp_lv_obj_remove_style_all(mp_obj_t obj_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
...
mp_obj_t mp_lv_obj_report_style_change(mp_obj_t style_in)
{
    lv_style_t *style = (lv_style_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(style_in))->obj);
...
mp_obj_t mp_lv_obj_refresh_style(mp_obj_t obj_in, mp_obj_t part_in, mp_obj_t style_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_part_t part = (lv_part_t)mp_obj_get_int(part_in);
    lv_style_t *style = (lv_style_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(style_in))->obj);
    
    lv_obj_refresh_style(obj, part, style);
    return mp_const_none;
}
/**
...
mp_obj_t mp_lv_obj_enable_style_refresh(mp_obj_t en_in)
{
    lv_obj_enable_style_refresh((bool)mp_obj_get_int(en_in));
    return mp_const_none;
}
/**
...
mp_obj_t mp_lv_obj_get_style_prop(mp_obj_t obj_in, mp_obj_t part_in, mp_obj_t prop_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_part_t part = (lv_part_t)mp_obj_get_int(part_in);
    lv_style_prop_t prop = (lv_style_prop_t)mp_obj_get_int(prop_in);
    
    lv_style_value_t ret = lv_obj_get_style_prop(obj, part, prop);
    return mp_lv_new_style_value(&ret);
}
...
mp_obj_t mp_lv_obj_has_style_prop(mp_obj_t obj_in, mp_obj_t selector_in, mp_obj_t prop_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
    lv_style_prop_t prop = (lv_style_prop_t)mp_obj_get_int(prop_in);
    
    bool ret = lv_obj_has_style_prop(obj, selector, prop);
...
//                                 lv_style_selector_t selector);
mp_obj_t mp_lv_obj_set_local_style_prop(mp_obj_t obj_in, mp_obj_t prop_in, mp_obj_t value_in, mp_obj_t selector_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_style_prop_t prop = (lv_style_prop_t)mp_obj_get_int(prop_in);
    lv_style_value_t *value = (lv_style_value_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(value_in))->obj);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//                                           lv_style_selector_t selector);
mp_obj_t mp_lv_obj_get_local_style_prop(mp_obj_t obj_in, mp_obj_t prop_in, mp_obj_t value_in, mp_obj_t selector_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_style_prop_t prop = (lv_style_prop_t)mp_obj_get_int(prop_in);
    lv_style_value_t *value = (lv_style_value_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(value_in))->obj);
    ...
    lv_style_res_t res = lv_obj_get_local_style_prop(obj, prop, value, selector);
...
mp_obj_t mp_lv_obj_remove_local_style_prop(mp_obj_t obj_in, mp_obj_t prop_in, mp_obj_t selector_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_style_prop_t prop = (lv_style_prop_t)mp_obj_get_int(prop_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
    
    bool res = lv_obj_remove_local_style_prop(obj, prop, selector);
    return mp_obj_new_bool(res);
}
/**
...
mp_obj_t mp_lv_obj_fade_in(mp_obj_t obj_in, mp_obj_t time_in, mp_obj_t delay_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t time = (uint32_t)mp_obj_get_int_truncated(time_in);
    uint32_t delay = (uint32_t)mp_obj_get_int_truncated(delay_in);
...
mp_obj_t mp_lv_obj_fade_out(mp_obj_t obj_in, mp_obj_t time_in, mp_obj_t delay_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t time = (uint32_t)mp_obj_get_int_truncated(time_in);
    uint32_t delay = (uint32_t)mp_obj_get_int_truncated(delay_in);
...
//}
mp_obj_t mp_lv_obj_style_get_selector_state(mp_obj_t selector_in)
{    
    lv_state_t res = lv_obj_style_get_selector_state((lv_style_selector_t)mp_obj_get_int(selector_in));
    return mp_obj_new_int((int)res);
}
...
//}
mp_obj_t mp_lv_obj_style_get_selector_part(mp_obj_t selector_in)
{    
    lv_part_t res = lv_obj_style_get_selector_part((lv_style_selector_t)mp_obj_get_int(selector_in));
    return mp_obj_new_int((int)res);
}
...
//}
mp_obj_t mp_lv_obj_set_style_pad_all(mp_obj_t obj_in, mp_obj_t value_in, mp_obj_t selector_in)
{       
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    int32_t value = (int32_t)mp_obj_get_int(value_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//    lv_obj_set_style_pad_right(obj, value, selector);
//}
mp_obj_t mp_lv_obj_set_style_pad_hor(mp_obj_t obj_in, mp_obj_t value_in, mp_obj_t selector_in)
{       
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    int32_t value = (int32_t)mp_obj_get_int(value_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//    lv_obj_set_style_pad_bottom(obj, value, selector);
//}
mp_obj_t mp_lv_obj_set_style_pad_ver(mp_obj_t obj_in, mp_obj_t value_in, mp_obj_t selector_in)
{       
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    int32_t value = (int32_t)mp_obj_get_int(value_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//}
mp_obj_t mp_lv_obj_set_style_margin_all(mp_obj_t obj_in, mp_obj_t value_in, mp_obj_t selector_in)
{       
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    int32_t value = (int32_t)mp_obj_get_int(value_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//    lv_obj_set_style_margin_right(obj, value, selector);
//}
mp_obj_t mp_lv_obj_set_style_margin_hor(mp_obj_t obj_in, mp_obj_t value_in, mp_obj_t selector_in)
{       
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    int32_t value = (int32_t)mp_obj_get_int(value_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//    lv_obj_set_style_margin_bottom(obj, value, selector);
//}
mp_obj_t mp_lv_obj_set_style_margin_ver(mp_obj_t obj_in, mp_obj_t value_in, mp_obj_t selector_in)
{       
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    int32_t value = (int32_t)mp_obj_get_int(value_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//}
mp_obj_t mp_lv_obj_set_style_pad_gap(mp_obj_t obj_in, mp_obj_t value_in, mp_obj_t selector_in)
{       
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    int32_t value = (int32_t)mp_obj_get_int(value_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//}
mp_obj_t mp_lv_obj_set_style_size(mp_obj_t obj_in, mp_obj_t width_in, mp_obj_t height_in, mp_obj_t selector_in)
{       
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
...
//}
mp_obj_t mp_lv_obj_set_style_transform_scale(mp_obj_t obj_in, mp_obj_t value_in, mp_obj_t selector_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    int32_t value = (int32_t)mp_obj_get_int(value_in);
    lv_style_selector_t selector = (lv_style_selector_t)mp_obj_get_int(selector_in);
...
//}
mp_obj_t mp_lv_obj_get_style_space_left(mp_obj_t obj_in, mp_obj_t part_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t part = (uint32_t)mp_obj_get_int_truncated(part_in);

    int32_t res = lv_obj_get_style_space_left(obj, part);
...
//}
mp_obj_t mp_lv_obj_get_style_space_right(mp_obj_t obj_in, mp_obj_t part_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t part = (uint32_t)mp_obj_get_int_truncated(part_in);

    int32_t res = lv_obj_get_style_space_right(obj, part);
    return mp_obj_new_int(res);
}
...
//}
mp_obj_t mp_lv_obj_get_style_space_top(mp_obj_t obj_in, mp_obj_t part_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t part = (uint32_t)mp_obj_get_int_truncated(part_in);

    int32_t res = lv_obj_get_style_space_top(obj, part);
    return mp_obj_new_int(res);
}
...
//}
mp_obj_t mp_lv_obj_get_style_space_bottom(mp_obj_t obj_in, mp_obj_t part_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t part = (uint32_t)mp_obj_get_int_truncated(part_in);

    int32_t res = lv_obj_get_style_space_bottom(obj, part);
    return mp_obj_new_int(res);
}
...
//}
mp_obj_t mp_lv_obj_get_style_transform_scale_x_safe(mp_obj_t obj_in, mp_obj_t part_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t part = (uint32_t)mp_obj_get_int_truncated(part_in);

    int32_t res = lv_obj_get_style_transform_scale_x_safe(obj, part);
    return mp_obj_new_int(res);
}
...
//    return zoom != 0 ? zoom : 1;
//}
mp_obj_t mp_lv_obj_get_style_transform_scale_y_safe(mp_obj_t obj_in, mp_obj_t part_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t part = (uint32_t)mp_obj_get_int_truncated(part_in);

    int32_t res = lv_obj_get_style_transform_scale_y_safe(obj, part);
    return mp_obj_new_int(res);
}
...
mp_obj_t mp_lv_obj_get_style_opa_recursive(mp_obj_t obj_in, mp_obj_t part_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    uint32_t part = (uint32_t)mp_obj_get_int_truncated(part_in);

    lv_opa_t res = lv_obj_get_style_opa_recursive(obj, part);
    return mp_obj_new_int((int)res);
}
