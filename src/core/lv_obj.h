...
mp_obj_t mp_lv_obj_create(mp_obj_t parent_in)
{
    lv_obj_t *parent;
    if (parent_in == mp_const_none) parent = NULL;
    else parent = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(parent_in))->obj);

    lv_obj_t *ret = lv_obj_class_create_obj(parent);
...
mp_obj_t mp_lv_obj_add_flag(mp_obj_t obj_in, mp_obj_t f_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_obj_flag_t f = (lv_obj_flag_t)mp_obj_get_int(f_in);
...
mp_obj_t mp_lv_obj_remove_flag(mp_obj_t obj_in, mp_obj_t f_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_obj_flag_t f = (lv_obj_flag_t)mp_obj_get_int(f_in);
...
mp_obj_t mp_lv_obj_update_flag(mp_obj_t obj_in, mp_obj_t f_in, mp_obj_t v_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_obj_flag_t f = (lv_obj_flag_t)mp_obj_get_int(f_in);
    bool v = (bool)mp_obj_get_int(v_in);
...
mp_obj_t mp_lv_obj_add_state(mp_obj_t obj_in, mp_obj_t state_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_state_t state = (lv_state_t)mp_obj_get_int(state_in);
...
mp_obj_t mp_lv_obj_remove_state(mp_obj_t obj_in, mp_obj_t state_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_state_t state = (lv_state_t)mp_obj_get_int(state_in);
...
mp_obj_t mp_lv_obj_set_state(mp_obj_t obj_in, mp_obj_t state_in, mp_obj_t v_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_state_t state = (lv_state_t)mp_obj_get_int(state_in);
    bool v = (bool)mp_obj_get_int(v_in);
...
//}
mp_obj_t mp_lv_obj_set_user_data(mp_obj_t obj_in, mp_obj_t user_data_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    void *user_data = (void *)(MP_OBJ_TO_PTR(user_data_in));
...
mp_obj_t mp_lv_obj_has_flag(mp_obj_t obj_in, mp_obj_t f_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_obj_flag_t f = (lv_obj_flag_t)mp_obj_get_int(f_in);
...
mp_obj_t mp_lv_obj_has_flag_any(mp_obj_t obj_in, mp_obj_t f_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_obj_flag_t f = (lv_obj_flag_t)mp_obj_get_int(f_in);
...
mp_obj_t mp_lv_obj_get_state(mp_obj_t obj_in)
{
    lv_state_t ret = lv_obj_get_state((lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj));
...
mp_obj_t mp_lv_obj_has_state(mp_obj_t obj_in, mp_obj_t state_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_state_t state = (lv_state_t)mp_obj_get_int(state_in);
...
mp_obj_t mp_lv_obj_get_group(mp_obj_t obj_in)
{
    lv_group_t *ret = lv_obj_get_group((lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj));
    return mp_lv_new_group(ret);
}
...
mp_obj_t mp_lv_obj_get_user_data(mp_obj_t obj_in)
{
    void *ret = lv_obj_get_user_data((lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj));

    mp_obj_t user_data = (mp_obj_t)MP_OBJ_FROM_PTR(ret);
    const mp_obj_type_t *user_data_type = mp_obj_get_type(user_data);
...
mp_obj_t mp_lv_obj_allocate_spec_attr(mp_obj_t obj_in)
{
    lv_obj_allocate_spec_attr((lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj));
    return mp_const_none;
}
...
mp_obj_t mp_lv_obj_check_type(mp_obj_t obj_in, mp_obj_t class_p_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
...
mp_obj_t mp_lv_obj_has_class(mp_obj_t obj_in, mp_obj_t class_p_in)
{
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
    lv_obj_class_t *class_p = (lv_obj_class_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(class_p_in))->obj);
...
mp_obj_t mp_lv_obj_get_class(mp_obj_t obj_in)
{
    lv_obj_class_t *ret = lv_obj_get_class((lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj));
    return mp_lv_new_obj_class(ret);
}
/**
...
mp_obj_t mp_lv_obj_is_valid(mp_obj_t obj_in)
{
    bool ret = lv_obj_is_valid((lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj));
    return mp_obj_new_bool(ret);
}
...
mp_obj_t mp_lv_obj_assign_id(mp_obj_t class_p_in, mp_obj_t obj_in)
{
    lv_obj_class_t *class_p = (lv_obj_class_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(class_p_in))->obj);
    lv_obj_t *obj = (lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj);
...
mp_obj_t mp_lv_obj_free_id(mp_obj_t obj_in)
{
    lv_obj_free_id((lv_obj_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(obj_in))->obj));
    return mp_const_none;
}
...
mp_obj_t mp_lv_objid_builtin_destroy(void)
{
