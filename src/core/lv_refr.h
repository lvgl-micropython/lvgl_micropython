...
mp_obj_t mp_lv_refr_now(mp_obj_t disp_in)
{
    if (disp_in == mp_const_none) lv_refr_now(NULL);
    else lv_refr_now((lv_display_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(disp_in))->obj));
...
mp_obj_t mp_lv_obj_redraw(mp_obj_t layer_in, mp_obj_t obj_in)
{
    lv_layer_t *layer =  (lv_layer_t *)((mp_lv_struct_t *)(MP_OBJ_TO_PTR(layer_in))->obj);
