from typing import Optional, Tuple, Union, ClassVar, Callable
...
class DisplayDriver:
    ...
    _offset_x: int = ...
    _offset_y: int = ...
    _data_bus: Union[lcd_bus.I80Bus, lcd_bus.I2CBus, lcd_bus.RGBBus, lcd_bus.SPIBus] = ...
    ...
    def __init__(
        self,
        data_bus: Union[lcd_bus.I80Bus, lcd_bus.I2CBus, lcd_bus.RGBBus, lcd_bus.SPIBus],
        display_width: int,
        display_height: int,
